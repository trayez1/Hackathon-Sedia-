// ============================================================================
// okayUway — MMU Cyberjaya Pilot Dataset (backend seed).
// Ported 1:1 from the original frontend mock (src/data/seed.js) so the real
// database starts out identical to the hackathon demo data.
// ============================================================================
...
export const LOCATIONS = [
  { id: "loc-library", name: "MMU Library", type: "Academic / Library", x: 300, y: 260, description: "Main library building, 4 floors." },
  { id: "loc-fci", name: "Faculty of Computing & Informatics (FCI)", type: "Faculty", x: 470, y: 190 },
  { id: "loc-foe", name: "Faculty of Engineering (FOE)", type: "Faculty", x: 620, y: 150 },
  { id: "loc-fom", name: "Faculty of Management (FOM)", type: "Faculty", x: 560, y: 300 },
  { id: "loc-fca", name: "Faculty of Cinematic Arts (FCA)", type: "Faculty", x: 700, y: 320 },
  { id: "loc-dtc", name: "Dewan Tun Canselor (DTC / Main Auditorium)", type: "Auditorium", x: 420, y: 380 },
  { id: "loc-admin", name: "Chancery (Administration Building)", type: "Administration", x: 300, y: 420, landmark: true },
  { id: "loc-cafeteria", name: "Cyber Café (Main Cafeteria)", type: "Food & Beverage", x: 400, y: 470 },
  { id: "loc-studentcentre", name: "Student Centre", type: "Student Services", x: 250, y: 480 },
  { id: "loc-sports", name: "Sports Complex & Multipurpose Hall", type: "Sports", x: 780, y: 480 },
  { id: "loc-hostel", name: "Residential College (Hostel Block C)", type: "Residential", x: 850, y: 220 },
  { id: "loc-clinic", name: "Health & Wellness Centre", type: "Health", x: 200, y: 350 },
  { id: "loc-parking", name: "Covered Parking (near FCI)", type: "Parking", x: 480, y: 90 },
  { id: "loc-gate", name: "Main Entrance Gate", type: "Entrance", x: 130, y: 500, landmark: true },
  { id: "loc-bestari", name: "BestariCom Lecture Hall Block", type: "Academic", x: 640, y: 420 },
];
...
export function buildInitialFeatures() {
  return [
...
export function buildInitialReports() {
  return [
    { id: "rep-seed-1", locationId: "loc-foe", featureId: "feat-foe-lift", type: "Broken lift", description: "Workshop wing lift out of service since Tuesday.", photoUrl: null, severity: "HIGH", status: "verified", createdAt: hoursAgo(6), confirmations: 9, disputes: 0, aiAnalysis: null },
    { id: "rep-seed-2", locationId: "loc-foe", featureId: "feat-foe-ramp", type: "Blocked ramp", description: "Delivery motorcycles parked across the loading-bay ramp.", photoUrl: null, severity: "HIGH", status: "pending", createdAt: minutesAgo(18), confirmations: 2, disputes: 1, aiAnalysis: { rampDetected: true, obstructionDetected: true, object: "Motorcycle", impact: "HIGH" } },
    { id: "rep-seed-3", locationId: "loc-cafeteria", featureId: "feat-cafe-pavement", type: "Damaged pavement", description: "Cracked tiles near the drinks stalls, wheels get stuck.", photoUrl: null, severity: "MEDIUM", status: "reviewing", createdAt: hoursAgo(4), confirmations: 5, disputes: 1, aiAnalysis: null },
    { id: "rep-seed-4", locationId: "loc-fca", featureId: "feat-fca-ramp", type: "Steep slope", description: "Studio-side ramp gradient feels unsafe without assistance.", photoUrl: null, severity: "MEDIUM", status: "verified", createdAt: daysAgo(5), confirmations: 5, disputes: 2, aiAnalysis: null },
  ];
}
